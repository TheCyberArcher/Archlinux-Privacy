...
yay -S librewolf-bin torbrowser-launcher thunderbird protonmail-bridge-bin solaar keepassxc webapp-manager qbittorrent btop onlyoffice-bin visual-studio-code-bin virtualbox virtualbox-host-dkms openrgb-bin corectrl ddcutil vlc webcord-bin telegram-desktop-bin signal-desktop steam lutris neofetch
